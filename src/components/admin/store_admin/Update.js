...
import { getOneServices } from "../../../api/services";
import {
  fetchStoresAsynk,
  setLoadingModal,
  updateStoresAsynk,
} from "../../../page/admin/Store/StoreSlice";
          ...
          >
            ...
            <div className="flex flex-row gap-12 items-start">
              ...
              <div className="flex items-center">
                ...
                {!isObject(image) && image.length > 3 && (
                  <img className="w-[70px] h-[70px]" src={image} />
                )}
              </div>
            </div>
